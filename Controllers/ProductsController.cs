...
namespace noche.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(IProductRepository productRepository) => _repository = productRepository;
        //{
        ...
        [HttpPost]
        public async Task<ResponseNocheServices> Create(Products products)
        {
            return await executeactionAsync(Action.CREATE, values: products);
        }

        [HttpPut("{id}")]
        public async Task<ResponseNocheServices> Update(string id, Products values)
        {
        ...
        private async Task<ResponseNocheServices> executeactionAsync(Action action, string id = "", Products values = null)
        {

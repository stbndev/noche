...
namespace noche.Controllers
{
    ...
    public class ModulesController : ControllerBase
    {
        ...
        public ModulesController(IModules ius) { _repository = ius; }

        [HttpPost]
        public async Task<ResponseNocheServices> Create(Modules values)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ResponseNocheServices> Update(string id, Modules values)
        {
        ...
        private async Task<ResponseNocheServices> executeactionAsync(Action action, string id = "", Modules values = null)
        {

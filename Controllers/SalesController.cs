...
namespace noche.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ResponseNocheServices> Create(Sales values)
        {
        ...
        private async Task<ResponseNocheServices> executeactionAsync(Action action, string id = "", Sales values = null)
        {
